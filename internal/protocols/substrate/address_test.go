...
func TestSS58AddressFormat(t *testing.T) {
	...
	tests := []struct {
		...
		// Mainnet
		{
			"ed25519-alice-edgeware-mainnet",
			args{
				EdgewareMainnet,
				ed25519test.AlicePublicKey,
			},
		...
		{
			"sr25519-alice-edgeware-mainnet",
			args{
				EdgewareMainnet,
		...
		// beresheet
		{
			"ed25519-alice-edgeware-beresheet",
			args{
				EdgewareBeresheet,
				ed25519test.AlicePublicKey,
			},
		...
		{
			"ed25519-bob-edgeware-beresheet",
			args{
				EdgewareBeresheet,
				ed25519test.BobPublicKey,
			},
		...
		{
			"sr25519-alice-edgeware-beresheet",
			args{
				EdgewareBeresheet,
				sr25519test.AlicePublicKey,
			},
		...
		{
			"sr25519-bob-edgeware-beresheet",
			args{
				EdgewareBeresheet,
				sr25519test.BobPublicKey,
			},
