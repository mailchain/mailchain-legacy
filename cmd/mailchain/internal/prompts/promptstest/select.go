...
func MustSelectItemSkipable(t *testing.T, wantItems []string, returnSelected string, returnSkipped bool, returnErr error) func(label string, items []string, skipable bool) (selected string, skipped bool, err error) {
