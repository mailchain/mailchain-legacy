...
func Test_easySeal(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args{
				[]byte("message"),
				sr25519test.CharlottePublicKey.Bytes(),
				bytes.NewReader([]byte("ABCDEFGHIJKLMNOPQRSTUVWXYZ")),
			},
			[]byte{0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4a, 0x4b, 0x4c, 0x4d, 0x4e, 0x4f, 0x50, 0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57, 0x58, 0x6f, 0x2d, 0x5d, 0xef, 0xa2, 0xef, 0x59, 0x5e, 0xfc, 0xe3, 0x5d, 0xe, 0x7a, 0x17, 0x11, 0xfc, 0xc5, 0xd7, 0xc8, 0x2c, 0xbf, 0x9f, 0x61},
			false,
		},
		{
			"err-rand",
