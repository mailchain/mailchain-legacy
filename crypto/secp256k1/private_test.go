...
func TestPrivateKey_Bytes(t *testing.T) {
	...
	tests := []struct {
		...
		{"A", fields{secp256k1test.ECDSAPrivateKeyA()}, []byte{0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa}},
		{"B", fields{secp256k1test.ECDSAPrivateKeyB()}, []byte{0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb}},
	}
...
func TestPrivateKey_PublicKey(t *testing.T) {
	...
	tests := []struct {
		...
		{"A", fields{secp256k1test.ECDSAPrivateKeyA()}, []byte{0x2, 0x6a, 0x4, 0xab, 0x98, 0xd9, 0xe4, 0x77, 0x4a, 0xd8, 0x6, 0xe3, 0x2, 0xdd, 0xde, 0xb6, 0x3b, 0xea, 0x16, 0xb5, 0xcb, 0x5f, 0x22, 0x3e, 0xe7, 0x74, 0x78, 0xe8, 0x61, 0xbb, 0x58, 0x3e, 0xb3}},
		{"B", fields{secp256k1test.ECDSAPrivateKeyB()}, []byte{0x2, 0x68, 0x68, 0x7, 0x37, 0xc7, 0x6d, 0xab, 0xb8, 0x1, 0xcb, 0x22, 0x4, 0xf5, 0x7d, 0xbe, 0x4e, 0x45, 0x79, 0xe4, 0xf7, 0x10, 0xcd, 0x67, 0xdc, 0x1b, 0x42, 0x27, 0x59, 0x2c, 0x81, 0xe9, 0xb5}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			pk := PrivateKeyFromECDSA(tt.fields.ecdsa)
...
func TestPrivateKeyFromECDSA(t *testing.T) {
	...
	tests := []struct {
		...
		{"A", args{secp256k1test.ECDSAPrivateKeyA()}, []byte{0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa}},
		{"B", args{secp256k1test.ECDSAPrivateKeyB()}, []byte{0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestPrivateKey_ECIES(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			"success",
			fields{
				secp256k1test.ECDSAPrivateKeyA(),
			},
			secp256k1test.ECDSAPrivateKeyA(),
		},
	}
	...
	tests := []struct {
	...
	}{
		{
			...
			func() *ecdsa.PrivateKey {
				k := secp256k1test.ECDSAPrivateKeyA()
				return &k
			}(),
			false,
		},
