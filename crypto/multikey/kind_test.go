...
func TestKeyKindFromSignature(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args{
				func() []byte {
					k, _ := secp256k1.PrivateKeyFromBytes(encodingtest.MustDecodeHex("01901E63389EF02EAA7C5782E08B40D98FAEF835F28BD144EECF5614A415943F"))
		...
		},
		{
			...
			args{
				func() []byte {
					k, _ := secp256k1.PrivateKeyFromBytes(encodingtest.MustDecodeHex("DF4BA9F6106AD2846472F759476535E55C5805D8337DF5A11C3B139F438B98B3"))
					return k.PublicKey().Bytes()
				}(),
				[]byte("message"),
