...
var ( //nolint
	sofiaSeed            = testutil.MustHexDecodeString("0x5c6d7adf75bda1180c225d25f3aa8dc174bbfb3cddee11ae9a85982f6faf791a")                                                                              //nolint: lll                                                                                                                                                                                                     //nolint: lll                                                                                                                                                                                                                                                                                                //nolint
	sofiaPrivateKey      = PrivateKey{&schnorrkel.PrivateKey{[32]byte{48, 120, 53, 99, 54, 100, 55, 97, 100, 102, 55, 53, 98, 100, 97, 49, 49, 56, 48, 99, 50, 50, 53, 100, 50, 53, 102, 51, 97, 97, 56}}} //nolint: lll
	...
	sofiaPublicKey       = PublicKey{&schnorrkel.PublicKey{[32]byte{48, 120, 49, 54, 57, 97, 49, 49, 55, 50, 49, 56, 53, 49, 102, 53, 100, 102, 102, 51, 53, 52, 49, 100, 100, 53, 99, 52, 98, 48, 98}}}   //nolint: lll
