...
func int() {
	var err error
	SofiaPrivateKey, err = sr25519.PrivateKeyFromBytes(testutil.MustDecodeBase58("0x5c6d7adf75bda1180c225d25f3aa8dc174bbfb3cddee11ae9a85982f6faf791a"))
	if err != nil {
		log.Fatal(err)
	}
	...
	CharlottePrivateKey, err = sr25519.PrivateKeyFromBytes(testutil.MustDecodeBase58("0x23b063a581fd8e5e847c4e2b9c494247298791530f5293be369e8bf23a45d2bd"))
	if err != nil {
		log.Fatal(err)
	}
