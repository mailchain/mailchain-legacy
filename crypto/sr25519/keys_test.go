...
var ( //nolint
	...
	sofiaPublicKey       = PublicKey{key: func() *schnorrkel.PublicKey {
		pubKey, err := schnorrkelPublicKeyFromBytes([]byte{0x16, 0x9a, 0x11, 0x72, 0x18, 0x51, 0xf5, 0xdf, 0xf3, 0x54, 0x1d, 0xd5, 0xc4, 0xb0, 0xb4, 0x78, 0xac, 0x1c, 0xd0, 0x92, 0xc9, 0xd5, 0x97, 0x6e, 0x83, 0xda, 0xa0, 0xd0, 0x3f, 0x26, 0x62, 0xc}) //nolint: lll
		if err != nil {
			panic(err)
		}
