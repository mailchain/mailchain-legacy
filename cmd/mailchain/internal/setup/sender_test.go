	...
	tests := []struct {
		...
		},
		{
			...
			fields{
				...
				promptstest.MockSelectItemSkipable(t, []string{names.EthereumRPC2}, "already-set", true, nil),
			},
			args{
				"ethereum",
				"mainnet",
		...
		},
		{
			...
			fields{
				...
				promptstest.MockSelectItemSkipable(t, []string{names.EthereumRPC2}, "new-value", false, nil),
			},
			args{
				"ethereum",
				"mainnet",
		...
		},
		{
			...
			fields{
				...
				promptstest.MockSelectItemSkipable(t, []string{names.EthereumRPC2}, "", false, errors.Errorf("failed to select")),
			},
			args{
				"ethereum",
				"mainnet",
	...
	tests := []struct {
		...
		},
		{
			...
			fields{
				...
				promptstest.MockSelectItemSkipable(t, []string{names.EthereumRPC2}, "", true, errors.Errorf("failed to skip")),
			},
			args{
				"ethereum",
				"mainnet",
		...
		},
		{
			...
			fields{
				...
				promptstest.MockSelectItemSkipable(t, []string{names.EthereumRPC2}, "new-setting", false, nil),
			},
			args{
				"ethereum",
				"mainnet",
