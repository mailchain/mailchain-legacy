...
func TestEncryptDecrypt(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			ed25519test.AlicePublicKey,
			ed25519test.AlicePrivateKey,
			[]byte("Hi Alice, this is a little bit of a longer message to make sure there are no problems"),
			nil,
		},
		{
			"to-bob-short-text",
		...
		},
		{
			...
			ed25519test.BobPublicKey,
			ed25519test.BobPrivateKey,
			[]byte("Hi Bob, this is a little bit of a longer message to make sure there are no problems"),
			nil,
		},
		{
			"to-alice-short-text",
